...
export default function CreatePerson() {
  ...
  const togglePersonType = () => {
    setPersonType(personType === pessoaFisica ? pessoaJuridica : pessoaFisica);
  };
  ...
  const onSubmit = (data: PersonPayload) => {
    data.type = personType === pessoaFisica ? PersonType.cliente : PersonType.fornecedor;
    data.cpfCnpj = personType === pessoaFisica ? data.cpfCnpj : data.cpfCnpj;
            ...
            <Box sx={formStyle}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  <FormControlLabel
                    control={<Switch onClick={togglePersonType} />}
                      ...
                      >
                        {(inputProps) => (
                          <TextField
                            {...inputProps}
                            fullWidth
                            label={personType === pessoaFisica ? "CPF" : "CNPJ"}
