...
const ReceivePayableTableSearch: React.FC<TableSearchProps> = ({ selectedRows, handleDelete, setParams: setPurchaseParams }) => {
...
export default ReceivePayableTableSearch;
