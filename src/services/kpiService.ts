...
export const getSaldoProjetadoService = async (params?: KpiParams): Promise<SaldoProjetado> => {
...
export const getDespesasService = async (params?: KpiParams): Promise<GetDespesas> => {
...
export const getVendasService = async (params?: KpiParams): Promise<GetVendas> => {
